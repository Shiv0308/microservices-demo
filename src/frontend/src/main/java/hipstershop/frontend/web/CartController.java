...
public class CartController {
    ...
    public String viewCart(
        ...
        // Coupon values are fixed numeric amounts in the shopper's selected currency, so SAVE10
        // always previews as 10 units of that currency and matches what checkoutservice charges.
