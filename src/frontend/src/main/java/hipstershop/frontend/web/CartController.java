...
public class CartController {
    ...
    public String viewCart(
        ...
        // Coupon face values are fixed amounts in the shopper's selected currency, so the
        // preview must use the current currency directly instead of converting from USD.
