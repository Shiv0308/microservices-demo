...
public class CartController {
    ...
    public String viewCart(
        ...
        // Applying a coupon on the cart page only previews it (existence + minimum-order
        ...
        // SAVE10/SAVE50/SAVE100 are fixed nominal discounts in the shopper's selected
        // currency, so the preview must use the current currency directly instead of
        // converting a USD amount.
